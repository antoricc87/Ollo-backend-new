...
// Patient is the ONLY identity this backend authenticates (physician/admin
// tokens removed 2026-08-29 — a clinician is a directory record, not a login).
export { signJWT, verifyToken, getUserToken, updateUserToken };
